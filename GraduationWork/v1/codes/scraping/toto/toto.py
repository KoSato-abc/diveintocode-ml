...
class toto():
    ...
    def scraping(self, only_new_data_flg):
        ...
        if only_new_data_flg:
            df = pd.read_csv('data/toto/toto_info_cleaned.csv', index_col=0).reset_index(drop=True)
        ...
        df_result.to_csv("data/toto/toto_info.csv")
    ...
    def clean(self):
        ...
        df = pd.read_csv('data/toto/toto_info.csv', index_col=0).reset_index(drop=True).fillna(0)
        ...
        df.to_csv("data/toto/toto_info_cleaned.csv")
