...
def pred_toto(toto_n, toto_kind):
    ...
    use_cols = ['第n回', '開催日', 'ホーム', 'アウェイ', 'is_even_lgbm', 'is_even_0_1_lgbm', 'is_even_lgbm_acc', 'is_lose_lgbm', 'is_lose_0_1_lgbm', 'is_lose_lgbm_acc', 'w_e_l_lgbm', 'w_e_l_0_2_lgbm', 'w_e_l_1_2_lgbm', 'w_e_l_lgbm_acc', 'goal_deff_lgbm', 'goal_deff_lgbm_rmse', 'H_goal_lgbm', 'H_goal_lgbm_rmse', 'A_goal_lgbm', 'A_goal_lgbm_rmse']
    train = train[use_cols + ['くじ結果']]
    test = test[use_cols]
